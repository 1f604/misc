...
DOH_SERVER = "1.1.1.1"
IP_API_SERVERS = ['https://checkip.amazonaws.com/', 'https://ipinfo.io/ip', 'https://api.ipify.org', 'https://bot.whatismyipaddress.com/', 'https://icanhazip.com/', 'https://ifconfig.me/', 'https://ident.me']
import sys
MIN_PYTHON = (3, 3)
